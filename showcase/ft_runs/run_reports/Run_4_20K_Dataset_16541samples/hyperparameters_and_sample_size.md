# Run 4: Large 20K Dataset (LR 1e-4)
**Log Event File**: `events.out.tfevents.1776098432.e18ce739cf4e.13621.0`  
**Adapter / Output Directory**: `/content/drive/MyDrive/ATRIA-G3/output_20K`

---

## 1. Executive Summary & Overview
Large-scale finetuning on ~16,541 dataset samples for 2.26 epochs with effective batch size 32.

| Key Performance Metric | Value |
| :--- | :---: |
| **Final Training Loss** | `0.2050` |
| **Minimum Evaluation Loss** | `0.2178` |
| **Peak Evaluation Token Accuracy** | **`91.16%`** |
| **Final Evaluation Token Accuracy** | `91.03%` |
...
* **Dataset / Sample Size ($N$)**: **`16,541 unique samples`**
  * Calculated as: $\text{Total Steps} \times \text{Effective Batch Size} / \text{Epochs} = 1170 \times 32 / 3 = 16,541$ samples.
* **Total Sample Exposures**: **`37,440`** training sample iterations across all epochs.
* **Total Gradient Steps Logged**: **`1,170`** steps.
