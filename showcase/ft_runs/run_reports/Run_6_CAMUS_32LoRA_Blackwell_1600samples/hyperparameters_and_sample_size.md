# Run 6: CAMUS 32-LoRA Blackwell (1,600 samples)
**Log Event File**: `events.out.tfevents.1776410801.613f842a7ad8.13245.0`  
**Adapter / Output Directory**: `/content/drive/MyDrive/ATRIA-G3/output_CAMUS-32LoRA-blackwell`

---

## 1. Executive Summary & Overview
Finetuning with LoRA rank r=32 on CAMUS dataset (1,600 samples) over 5 epochs with effective batch size 64.

| Key Performance Metric | Value |
| :--- | :---: |
| **Final Training Loss** | `0.2528` |
| **Minimum Evaluation Loss** | `0.2586` |
| **Peak Evaluation Token Accuracy** | **`89.48%`** |
| **Final Evaluation Token Accuracy** | `89.48%` |
...
* **Dataset / Sample Size ($N$)**: **`1,600 unique samples`**
  * Calculated as: $\text{Total Steps} \times \text{Effective Batch Size} / \text{Epochs} = 125 \times 64 / 5 = 1,600$ samples.
* **Total Sample Exposures**: **`8,000`** training sample iterations across all epochs.
* **Total Gradient Steps Logged**: **`125`** steps.
